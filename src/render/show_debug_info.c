...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/02 00:09:29 by fvargas           #+#    #+#             */
/*   Updated: 2025/07/02 00:09:30 by fvargas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	show_debug_info(t_data *dt)
{
	...
	mlx_string_put(mlx, win, field_1_x, y += DEBUG_MENU_NL, UI_CLR_2, "Casted rays:");
	mlx_string_put(mlx, win, field_2_x, y, UI_CLR_2, ft_itoa(CASTED_RAYS_COUNT));
